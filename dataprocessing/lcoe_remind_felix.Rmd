...
# cost components
cost.colors.te <- c("Additional H2 t&d Cost" = "grey",
                 "FE Tax" = "darkseagreen",
                 "Flex Tax" = "lightblue",
...
cost.colors.sys <- c("Additional H2 t&d Cost" = "grey",
                 "FE Tax" = "darkseagreen",
                 "Flex Tax" = "lightblue",
                 "CO2 Provision Cost" = "grey80",
                 "Curtailment Cost" = "darkblue",
...
cost.colors.sys.wh2 <- c(cost.colors.sys, "flexibility subsidy" = "lightblue")
...
```{r}
#total (marginal) LCOE per tech (with a unit of $/(MWh total generation), curtailment cost comes on top of it, and together it gives $/(MWh usable generation) )
...
ggsave(plot = p.sysLCOE_wmarkup, filename = paste0(plot.dir, run_number, "_LCOE_", plot.name, "_", plot.scen, ".png"),width = 14, height =7)
...
ggsave(plot = p.sysLCOE_wmarkup, filename = paste0(plot.dir, run_number, "_LCOE_", plot.name, "_REMIND_nocurt.png"),width = 14, height =7)
