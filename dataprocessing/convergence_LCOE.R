...
VAR_report_key4_DT = c("fuel cost - divided by eta ($/MWh)")
...
ggsave(filename = paste0(mypath, run_number, "_fuelcost_timeseries.png"), width = 16, height =10, units = "in", dpi = 120)
