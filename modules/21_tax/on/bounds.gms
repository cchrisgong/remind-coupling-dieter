...
vm_Mrkup.fx(t,all_regi,all_te)$(teDTCoupSupp(all_te) AND not regDTCoup(regi)) = 0;

*** CG: set spv markups to 0 for non-coupled years for coupled regions
vm_Mrkup.fx(t,all_regi,all_te)$(teDTCoupSupp(all_te) AND regDTCoup(regi) AND not tDT32(t)) = 0;
