...
p21_taxrevFlex0(t,regi) = sum(en2en(enty,enty2,te)$(COUPte(te)),
                                        -vm_flexAdj.l(t,regi,te) * vm_prodSe.l(t,regi,enty,enty2,te));

display "vm_flexAdj", vm_flexAdj.l;
Display "reference in postsolve", p21_taxrevFlex0;
sm21_tmp = iteration.val;
display "iteration", sm21_tmp;

* vm_flexAdj.fx(ttot,all_regi,all_te)$(COUPte(all_te) AND iteration.val le 4) = 0;
...
p21_taxrevFlex_iter(iteration+1,ttot,regi)$(cm_DTcoup_capcon = 1) = v21_taxrevFlex.l(ttot,regi);
