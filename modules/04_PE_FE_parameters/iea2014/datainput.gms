...
*** the following two co-productions are disabled since they might influence results in dieter coupling
p04_prodCoupleGlob("pebiolc","seliqbio","bioftrec","seel")  = 0; !! from Liu et al. 2011 (Making Fischer-Tropsch Fuels and Electricity from Coal and Biomass: Performance and Cost Analysis)
p04_prodCoupleGlob("pebiolc","seliqbio","bioftcrec","seel") = 0; !! from Liu et al. 2011 (Making Fischer-Tropsch Fuels and Electricity from Coal and Biomass: Performance and Cost Analysis)
